...
#region weapon Stuff
 ...
 weapon_x_offset = 10;
 weapon_y_offset = 4;
 if(global.SuperPlungerCanBeUsed = 1)
 {
	weapon = instance_create_depth(x,y, depth -1, Obj_SuperPlunger);
	weapon_x_offset = 10;
	weapon_y_offset = 4;
