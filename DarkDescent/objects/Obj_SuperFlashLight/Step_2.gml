...
if(surface_exists(darkness))
{
	...
	with(obj_lightSource)
	{
		...
		//draw_set_alpha(10);
		draw_sprite_ext(Spr_SuperFlashlight,0,x-view_xport[0], y-view_yport[0],1,1,point_direction(x, y, mouse_x, mouse_y), c_black, 1);
